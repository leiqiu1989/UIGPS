                    ...
                    <div class="panel-body">
                        <div class="layui-form auto-label-width">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="checkbox" title="In geofence" lay-skin="primary" />
                                    <input type="checkbox" title="Out of geofence" lay-skin="primary" />
                                </div>
                            </div>
                            <div class="layui-form-item">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-offset-4 col-sm-8">
                                    <button class="layui-btn layui-btn-small layui-btn-normal w-100 js-search">Save</button>
                                    <button class="layui-btn layui-btn-small layui-btn-normal w-100 js-cancel">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
