<div class="panel panel-transparent flexbox full">
    <div class="panel-heading">
        <h3 class="panel-title" data-localize="PunctuationManagement.PunctuationManagement">地标点管理</h3>
    </div>
    <div class="panel-toolbar">
        <div class="layui-form auto-label-width layui-form-inline">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label" data-localize="PunctuationManagement.PunctuationName">地标名称</label>
