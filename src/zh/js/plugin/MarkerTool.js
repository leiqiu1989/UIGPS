...
(function() {
    ...
    var MarkerTool =
         ...
         */
        BMapLib.MarkerTool = function(map, opts, callback) {
    ...
    /**
     * 在地图上标注
     * @param {mapPoint} 地图点经纬度
     */
    MarkerTool.prototype.markPoint = function(mapPoint) {
        var me = this;
        ...
        me.setPoint(mapPoint);
        me._map.addOverlay(mkr);
        mkr.enableDragging();
        me.setPointValue(mapPoint);
        // mkr添加拖拽事件
        mkr.addEventListener('dragstart', function() {
            //me._map.removeOverlay(me._cricle);
        });
    ...
    MarkerTool.prototype.setPointValue = function(pt) {
        $('.js-lng').text(pt.lng);
        $('.js-lat').text(pt.lat);
    };
    /**
    ...
    MarkerTool.prototype.getPoint = function() {
        return this._Point;
    };
    MarkerTool.prototype.setPoint = function(point) {
        this._Point = point;
    };
    /**
    ...
    MarkerTool.prototype._addCricle = function(pt) {
        var mapPoint = new BMap.Point(pt.lng, pt.lat);
        var circle = new BMap.Circle(mapPoint, this._opts.area, {
            strokeColor: '#B7AD76',
            fillColor: '#95E0DC',
            strokeWeight: 1,
            strokeOpacity: 1,
