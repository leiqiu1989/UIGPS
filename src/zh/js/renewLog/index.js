define(function(require, exports, module) {
    ...
    // 模板
    var tpls = {
        index: require('../../tpl/renewLog/index'),
        list: require('../../tpl/renewLog/list')
    };

    function renewLog() {}
    $.extend(renewLog.prototype, {
        init: function(param) {
            // 初始化查询条件参数
        ...
        initControl: function() {
            ...
            common.subordinateTree({
                ...
                SimCardNo: me.searchParam.SimCardNo, //SIM卡号
        ...
        getData: function() {
            ...
            common.loading('show');
            common.ajax(api.renewLogManager.list, param, function(res) {
                if (res.status === 'SUCCESS') {
                    var content = res.content || {};
                    var total = content.TotalCount || 0;
                    var data = content.Page || [];
                    $('#renewLogList > table > tbody').empty().html(template.compile(tpls.list)({
                        data: data
                    }));
                    common.page(total, param.PageSize, param.PageIndex, function(currPage) {
                        me.searchParam.PageIndex = currPage;
                        common.changeHash('#renewLog/index/', me.searchParam);
                    });
                } else {
            ...
            if (reset) {
                ...
                if (param && _.isEmpty(param)) {
                    _param = {
                        ...
                        SimCardNo: common.getElValue('#selSIM'),
    ...
    var _renewLog = new renewLog();

    exports.init = function(param) {
        _renewLog.init(param);
    };
});